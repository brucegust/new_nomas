...
<head>
    ...
    <link href="http://nomas.site/assets/css/animate.css" rel="stylesheet" />
    <link href="http://nomas.site/assets/css/satellite.style.css" rel="stylesheet">
                ...
                <div class="row">
                    <div class="col-md-12">
						<div class="row">
							...
							<!-- start login links-->
																		<a href="#" style="color:#fff; font-weight:bold;" href="http://nomas.site/login">Login</a>&nbsp;|&nbsp;
										<a href="#" style="color:#fff; font-weight:bold;" href="http://nomas.site/register">Register</a>
															<!-- end login links -->
							</div>
						</div>
                    </div>
        ...
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="http://nomas.site/assets/img/logo.png" class="logo">
                </a>
            </div>
...
<script src="http://nomas.site/assets/js/jquery.min.js"></script>
<script src="http://nomas.site/assets/js/bootstrap.min.js"></script>
<script src="http://nomas.site/assets/js/jquery.easing.min.js"></script>
<script src="http://nomas.site/assets/js/wow.min.js"></script>
<script src="http://nomas.site/assets/js/jquery.scrollTo.js"></script>
<script src="http://nomas.site/assets/js/jquery.appear.js"></script>
<script src="http://nomas.site/assets/js/stellar.js"></script>
<script src="http://nomas.site/assets/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
<script src="http://nomas.site/assets/js/owl.carousel.min.js"></script>
<script src="http://nomas.site/assets/js/nivo-lightbox.min.js"></script>
<script src="http://nomas.site/assets/js/custom.js"></script>
