                ...
                <div class="col-sm-3 col-md-3">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box text-center">
                            ...
                            <h4 class="h-bold">Licensed Professional</h4>
                            <p>
                                Learn more about how to become a NOMAS<sup>&reg;</sup> Licensed Professional (NLP)
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 col-md-3">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box text-center">
                            ...
                            <p>
                                Join the online community of professionals dedicated to successful neonatal feeding and innovation!
                            </p>
                        </div>
                    </div>
                </div>
