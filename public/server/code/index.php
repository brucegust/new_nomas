...
<head>
    ...
    <!-- css -->
    <link href="http://new.brucegust.com/nomas/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link href="http://new.brucegust.com/nomas/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="http://new.brucegust.com/nomas/assets/plugins/cubeportfolio/css/cubeportfolio.min.css">
    <link href="http://new.brucegust.com/nomas/assets/css/nivo-lightbox.css" rel="stylesheet" />
    <link href="http://new.brucegust.com/nomas/assets/css/nivo-lightbox-theme/default/default.css" rel="stylesheet" type="text/css" />
    <link href="http://new.brucegust.com/nomas/assets/css/owl.carousel.css" rel="stylesheet" media="screen" />
    <link href="http://new.brucegust.com/nomas/assets/css/owl.theme.css" rel="stylesheet" media="screen" />
    <link href="http://new.brucegust.com/nomas/assets/css/animate.css" rel="stylesheet" />
    <link href="http://new.brucegust.com/nomas/assets/css/style.css" rel="stylesheet">

    <!-- boxed bg -->
    <link id="bodybg" href="http://new.brucegust.com/nomas/assets/bodybg/bg1.css" rel="stylesheet" type="text/css" />
    <!-- template skin -->
    <link id="t-colors" href="http://new.brucegust.com/nomas/assets/color/pink.css" rel="stylesheet">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <p class="bold text-left" style="margin-top:3px;">NOMAS<sup>&reg;</sup> Training Schedule </p>
                    </div>
                    <div class="col-sm-6 col-md-6">
        ...
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="http://new.brucegust.com/nomas/assets/img/logo.png" alt="" width="300" height="53" />
                </a>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                            <img src="http://new.brucegust.com/nomas/assets/img/dummy/img-1.png" class="img-responsive" alt="" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="service" class="home-section nopadding paddingtop-60">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img src="http://new.brucegust.com/nomas/assets/img/dummy/img-1.jpg" class="img-responsive" alt="" />
                    </div>
                </div>
                        ...
                        <ul>
                            <li class="cbp-item psychiatrist">
                                <a href="doctors/member1.html" class="cbp-caption cbp-singlePage">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="http://new.brucegust.com/nomas/assets/img/team/1.jpg" alt="" width="100%">
                                    </div>
                            ...
                            <li class="cbp-item cardiologist">
                                <a href="doctors/member2.html" class="cbp-caption cbp-singlePage">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="http://new.brucegust.com/nomas/assets/img/team/2.jpg" alt="" width="100%">
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                            ...
                            <li class="cbp-item cardiologist">
                                <a href="doctors/member3.html" class="cbp-caption cbp-singlePage">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="http://new.brucegust.com/nomas/assets/img/team/3.jpg" alt="" width="100%">
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                            ...
                            <li class="cbp-item neurologist">
                                <a href="doctors/member4.html" class="cbp-caption cbp-singlePage">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="http://new.brucegust.com/nomas/assets/img/team/4.jpg" alt="" width="100%">
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignCenter">
                                            <div class="cbp-l-caption-body">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="wow bounceInUp" data-wow-delay="0.2s">
                        <div id="owl-works" class="owl-carousel">
                            <div class="item"><a href="img/photo/1.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg"><img src="http://new.brucegust.com/nomas/assets/img/photo/1.jpg" class="img-responsive" alt="img"></a></div>
                            <div class="item"><a href="img/photo/2.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/2@2x.jpg"><img src="http://new.brucegust.com/nomas/assets/img/photo/2.jpg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="img/photo/3.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/3@2x.jpg"><img src="http://new.brucegust.com/nomas/assets/img/photo/3.jpg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="img/photo/4.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/4@2x.jpg"><img src="http://new.brucegust.com/nomas/assets/img/photo/4.jpg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="img/photo/5.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/5@2x.jpg"><img src="http://new.brucegust.com/nomas/assets/img/photo/5.jpg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="img/photo/6.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/6@2x.jpg"><img src="http://new.brucegust.com/nomas/assets/img/photo/6.jpg" class="img-responsive " alt="img"></a></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="carousel-reviews" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="item active">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="person-text rel text-light">
                                        ...
                                        <!--<img src="http://new.brucegust.com/nomas/assets/img/testimonials/1.jpg" alt="" class="person img-circle" /> -->
                                        <a title="" href="#">Anna</a>
                        ...
                        <span
                                data-value="3" class="glyphicon glyphicon-star-empty"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span> </span>
                                    ...
                                    <div class="person-text rel text-light">
                                        <img src="http://new.brucegust.com/nomas/assets/img/testimonials/2.jpg" alt="" class="person img-circle" />
                                ...
                                <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                    ...
                                    <div class="person-text rel text-light">
                                        <img src="http://new.brucegust.com/nomas/assets/img/testimonials/3.jpg" alt="" class="person img-circle" />
                            ...
                            <div class="item">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="person-text rel text-light">
                                        <img src="http://new.brucegust.com/nomas/assets/img/testimonials/4.jpg" alt="" class="person img-circle" />
                        ...
                        <span
                                data-value="3" class="glyphicon glyphicon-star-empty"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span> </span>
                                    ...
                                    <div class="person-text rel text-light">
                                        <img src="http://new.brucegust.com/nomas/assets/img/testimonials/5.jpg" alt="" class="person img-circle" />
                                ...
                                <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                    ...
                                    <div class="person-text rel text-light">
                                        <img src="http://new.brucegust.com/nomas/assets/img/testimonials/6.jpg" alt="" class="person img-circle" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="partner">
                        <a href="#"><img src="http://new.brucegust.com/nomas/assets/img/dummy/partner-2.jpg" alt="" /></a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="partner">
                        <a href="#"><img src="http://new.brucegust.com/nomas/assets/img/dummy/partner-3.jpg" alt="" /></a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="partner">
                        <a href="#"><img src="http://new.brucegust.com/nomas/assets/img/dummy/partner-4.jpg" alt="" /></a>
                    </div>
                </div>
                -->
            </div>
...
<script src="http://new.brucegust.com/nomas/assets/js/jquery.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/bootstrap.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/jquery.easing.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/wow.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/jquery.scrollTo.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/jquery.appear.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/stellar.js"></script>
<script src="http://new.brucegust.com/nomas/assets/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/owl.carousel.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/nivo-lightbox.min.js"></script>
<script src="http://new.brucegust.com/nomas/assets/js/custom.js"></script>
